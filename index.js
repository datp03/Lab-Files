...
function checkPass() {
  ...
  function verifyPassword() {  
    ...
    if(pw == "") {  
       document.getElementById("message1").innerHTML = "User ID can not be empty";  
       return false;  
    }  
      
    if(pw.length < 8) {  
       document.getElementById("message1").innerHTML = "**Password length must be at least 6 words";  
       return false;  
    }  
     
    if(pw.length > 15) {  
       document.getElementById("message1").innerHTML = "**Password length must not over 12 words";  
       return false;  
    } else {  
